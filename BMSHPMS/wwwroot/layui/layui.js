        ...
        "function" != typeof r
          ...
          : ((function f() {
              return ++p > (1e3 * n.timeout) / 100
                ? a(t + " timeout")
                : void (1989 ===
                  parseInt(i.getStyle(e.getElementById(s), "width"))
                    ? (function () {
                        r();
                      })()
                    : setTimeout(f, 100));
...
layui.define(function (e) {
  ...
  var t = document,
    ...
    u = function (e) {
      var t = this;
      (t.config = e || {}), (t.config.index = ++p.index), t.render(!0);
    };
  (u.prototype.type = function () {
    ...
    (u.prototype.view = function () {
      var e = this,
        t = e.config,
        a = (t.groups = "groups" in t ? 0 | t.groups : 5);
      (t.layout =
        "object" == typeof t.layout ? t.layout : ["prev", "page", "next"]),
        (t.count = 0 | t.count),
        (t.curr = 0 | t.curr || 1),
        (t.limits =
          "object" == typeof t.limits ? t.limits : [10, 20, 30, 40, 50]),
        (t.limit = 0 | t.limit || 10),
        (t.pages = Math.ceil(t.count / t.limit) || 1),
        t.curr > t.pages && (t.curr = t.pages),
        a < 0 ? (a = 1) : a > t.pages && (a = t.pages),
        (t.prev = "prev" in t ? t.prev : "&#x4E0A;&#x4E00;&#x9875;"),
        (t.next = "next" in t ? t.next : "&#x4E0B;&#x4E00;&#x9875;"),
        (t.rpptext = "rpptext" in t ? t.rpptext : "条/页"),
        (t.totaltext = "totaltext" in t ? t.totaltext : "共"),
        (t.recordtext = "recordtext" in t ? t.recordtext : "条"),
        (t.gototext = "gototext" in t ? t.gototext : "&#x5230;&#x7B2C;"),
        (t.pagetext = "pagetext" in t ? t.pagetext : "页"),
        (t.oktext = "oktext" in t ? t.oktext : "&#x786e;&#x5b9a;");
      var r =
          t.pages > a
            ? Math.ceil((t.curr + (a > 1 ? 1 : 0)) / (a > 0 ? a : 1))
            : 1,
        n = {
          prev: (function () {
            return t.prev
              ...
              i === t.curr
                ? e.push(
                    '<span class="layui-laypage-curr"><em class="layui-laypage-em" ' +
                      (/^#/.test(t.theme)
                        ? 'style="background-color:' + t.theme + ';"'
                        : "") +
                      "></em><em>" +
                      i +
                      "</em></span>"
          ...
          limit: (function () {
            ...
            return (
              layui.each(t.limits, function (a, r) {
                e.push(
                  '<option value="' +
                    r +
                    '"' +
          ...
          skip: (function () {
            return [
              '<span class="layui-laypage-skip">' + t.gototext,
      ...
      return [
        ...
        (function () {
          var e = [];
          return (
            layui.each(t.layout, function (t, a) {
              n[a] && e.push(n[a]);
            }),
            e.join("")
          );
    ...
    (u.prototype.jump = function (e, t) {
      if (e) {
        ...
        for (var c = 0, g = i.length; c < g; c++)
          "a" === i[c].nodeName.toLowerCase() &&
            p.on(i[c], "click", function () {
              var e = 0 | this.getAttribute("data-page");
              e < 1 || e > n.pages || ((n.curr = e), a.render());
            });
        s &&
          p.on(s, "change", function () {
            var e = this.value;
    ...
    (u.prototype.skip = function (e) {
      if (e) {
        var t = this,
          a = e[r]("input")[0];
        a &&
          p.on(a, "keyup", function (a) {
            var r = this.value,
              n = a.keyCode;
            /^(37|38|39|40)$/.test(n) ||
              (/\D/.test(r) && (this.value = r.replace(/\D/, "")),
              13 === n && t.jump(e, !0));
          });
      }
    }),
    (u.prototype.render = function (e) {
      var r = this,
        ...
        u = r.view();
      2 === i
        ? n.elem && (n.elem.innerHTML = u)
        : 3 === i
        ? n.elem.html(u)
        : t[a](n.elem) && (t[a](n.elem).innerHTML = u),
        n.jump && n.jump(n, e);
      var p = t[a]("layui-laypage-" + n.index);
      r.jump(p),
      ...
      return (
        e.attachEvent
          ? e.attachEvent("on" + t, function (t) {
              (t.target = t.srcElement), a.call(e, t);
            })
      ...
      var e = this,
        ...
        a = {
          cn: {
            ...
            tools: { confirm: "確定", clear: "清空", now: "現在" },
          ...
          select: function () {
                ...
                if (!u) {
                  var C = function () {
                      ...
                      (b = p[0].selectedIndex),
                        ...
                        k.removeClass(o),
                        (y = null),
                        k.eq(b).addClass(s).siblings().removeClass(s),
            ...
            f.each(function (e, l) {
              ...
              var h = "string" == typeof r.attr("lay-search"),
                ...
                m =
                  void 0 === f[0].attributes.icon ||
                  null === f[0].attributes.icon
                    ? ""
                    : '<i class="_wtm-combo-icon ' +
                      f[0].attributes.icon.value +
                    ...
                    (function (e) {
                      ...
                      return (
                        layui.each(e, function (e, a) {
                          if (0 !== e || a.value)
                            if ("optgroup" === a.tagName.toLowerCase())
                              t.push("<dt>" + a.label + "</dt>");
                            else {
                              var n =
                                "undefined" == typeof a.getAttribute("icon") ||
                                null === typeof a.getAttribute("icon")
                                  ? ""
                                  : '<i class="' +
                                    a.getAttribute("icon") +
                                    '" style="margin-right: 5px;"></i>';
              ...
              o[0] && o.remove(), r.after(g), y.call(this, g, u, h);
            });
          },
          checkbox: function () {
            var e = {
