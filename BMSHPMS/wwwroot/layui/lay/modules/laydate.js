...
! function () {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        ], r.list(s.type, 0).list(s.type, 1), "time" === s.type ? r.setBtnStatus("時間", w.extend({}, r.systemDate(), r.startTime), w.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))), s.range || (r.listYM = [
            [l.year, l.month + 1]
        ...
        var n = this,
            ...
            o = {
                ...
                confirm: function () {
                    if (a.range) {
                        if (!n.endDate) return n.hint("請先選擇日期範圍");
                        if (w(e).hasClass(s)) return n.hint("time" === a.type ? l.replace(/日期/g, "時間") : l)
                    } else if (w(e).hasClass(s)) return n.hint("不在有效日期或時間範圍內");
