...
namespace BMSHPMS.DSManage.Controllers
{
    ...
    public partial class DSReceiptInfoController : BaseController
    {
        #region Search
        [ActionDescription("Sys.Search")]
        public ActionResult Index()
        {
            var vm = Wtm.CreateVM<DSReceiptInfoListVM>();
            return PartialView(vm);
        }

        [ActionDescription("Sys.Search")]
        [HttpPost]
        public string Search(DSReceiptInfoSearcher searcher)
        {
            var vm = Wtm.CreateVM<DSReceiptInfoListVM>(passInit: true);
        ...
        {
            var vm = Wtm.CreateVM<DSReceiptInfoVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("Sys.Create")]
        public ActionResult Create(DSReceiptInfoVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        public ActionResult Edit(DSReceiptInfoVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        [HttpPost]
        [ActionDescription("Sys.BatchEdit")]
        public ActionResult DoBatchEdit(DSReceiptInfoBatchVM vm, IFormCollection nouse)
        {
