...
namespace BMSHPMS.DSManage.Controllers
{
    ...
    public partial class DSDonorInfoController : BaseController
    {
        #region Search
        [ActionDescription("Sys.Search")]
        public ActionResult Index()
        {
            var vm = Wtm.CreateVM<DSDonorInfoListVM>();
            return PartialView(vm);
        }

        [ActionDescription("Sys.Search")]
        [HttpPost]
        public string Search(DSDonorInfoSearcher searcher)
        {
            var vm = Wtm.CreateVM<DSDonorInfoListVM>(passInit: true);
        ...
        {
            var vm = Wtm.CreateVM<DSDonorInfoVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("Sys.Create")]
        public ActionResult Create(DSDonorInfoVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        {
            var vm = Wtm.CreateVM<DSDonorInfoVM>(id);
            return PartialView(vm);
        }
        ...
        public ActionResult Edit(DSDonorInfoVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
  ...
  //      }
        ...
        [HttpPost]
        public IActionResult ExportExcel(DSDonorInfoListVM vm)
        {
