...
namespace BMSHPMS.DSManage.Controllers
{
    ...
    public partial class DSLongevityInfoController : BaseController
    {
        #region Search
        [ActionDescription("Sys.Search")]
        public ActionResult Index()
        {
            var vm = Wtm.CreateVM<DSLongevityInfoListVM>();
            return PartialView(vm);
        }

        [ActionDescription("Sys.Search")]
        [HttpPost]
        public string Search(DSLongevityInfoSearcher searcher)
        {
            var vm = Wtm.CreateVM<DSLongevityInfoListVM>(passInit: true);
        ...
        {
            var vm = Wtm.CreateVM<DSLongevityInfoVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("Sys.Create")]
        public ActionResult Create(DSLongevityInfoVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
        ...
        {
            var vm = Wtm.CreateVM<DSLongevityInfoVM>(id);
            return PartialView(vm);
        }
        ...
        public ActionResult Edit(DSLongevityInfoVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
  ...
  //      }
        ...
        [HttpPost]
        public IActionResult ExportExcel(DSLongevityInfoListVM vm)
        {
