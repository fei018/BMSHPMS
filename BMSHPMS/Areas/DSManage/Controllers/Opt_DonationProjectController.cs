...
namespace BMSHPMS.DSManage.Controllers
{
    ...
    public partial class Opt_DonationProjectController : BaseController
    {
        ...
        {
            var vm = Wtm.CreateVM<Opt_DonationProjectListVM>();
            return PartialView(vm);
        }

        [ActionDescription("Sys.Search")]
        [HttpPost]
        public string Search(Opt_DonationProjectSearcher searcher)
        {
            var vm = Wtm.CreateVM<Opt_DonationProjectListVM>(passInit: true);
        ...
        {
            var vm = Wtm.CreateVM<Opt_DonationProjectVM>();
            return PartialView(vm);
        }

        [HttpPost]
        [ActionDescription("Sys.Create")]
        public ActionResult Create(Opt_DonationProjectVM vm)
        {
            if (!ModelState.IsValid)
            {
                return PartialView(vm);
