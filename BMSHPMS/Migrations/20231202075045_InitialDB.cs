        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiptDate = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "開收據日期"),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreateBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdateBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DSReceipts", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Serial = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "編號"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DSDonorSerials", x => x.ID);
                    table.ForeignKey(
                        name: "FK_DSDonorSerials_DSReceipts_ReceiptID",
                        column: x => x.ReceiptID,
                        principalTable: "DSReceipts",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DSLeadDonors", x => x.ID);
                    table.ForeignKey(
                        name: "FK_DSLeadDonors_DSReceipts_ReceiptID",
                        column: x => x.ReceiptID,
                        principalTable: "DSReceipts",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DSLongevitys", x => x.ID);
                    table.ForeignKey(
                        name: "FK_DSLongevitys_DSReceipts_ReceiptID",
                        column: x => x.ReceiptID,
                        principalTable: "DSReceipts",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DSLongevitySerials", x => x.ID);
                    table.ForeignKey(
                        name: "FK_DSLongevitySerials_DSReceipts_ReceiptID",
                        column: x => x.ReceiptID,
                        principalTable: "DSReceipts",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DSMemorials", x => x.ID);
                    table.ForeignKey(
                        name: "FK_DSMemorials_DSReceipts_ReceiptID",
                        column: x => x.ReceiptID,
                        principalTable: "DSReceipts",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DSMemorialSerials", x => x.ID);
                    table.ForeignKey(
                        name: "FK_DSMemorialSerials_DSReceipts_ReceiptID",
                        column: x => x.ReceiptID,
                        principalTable: "DSReceipts",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DSDonorSerials_ReceiptID",
                table: "DSDonorSerials",
                column: "ReceiptID");

            migrationBuilder.CreateIndex(
                name: "IX_DSDonorSerials_Serial",
                table: "DSDonorSerials",
                column: "Serial",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DSLeadDonors_ReceiptID",
                table: "DSLeadDonors",
                column: "ReceiptID");

            migrationBuilder.CreateIndex(
                name: "IX_DSLongevitys_ReceiptID",
                table: "DSLongevitys",
                column: "ReceiptID");

            migrationBuilder.CreateIndex(
                name: "IX_DSLongevitySerials_ReceiptID",
                table: "DSLongevitySerials",
                column: "ReceiptID");

            migrationBuilder.CreateIndex(
                name: "IX_DSLongevitySerials_Serial",
                table: "DSLongevitySerials",
                column: "Serial",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DSMemorials_ReceiptID",
                table: "DSMemorials",
                column: "ReceiptID");

            migrationBuilder.CreateIndex(
                name: "IX_DSMemorialSerials_ReceiptID",
                table: "DSMemorialSerials",
                column: "ReceiptID");

            migrationBuilder.CreateIndex(
                name: "IX_DSMemorialSerials_Serial",
                table: "DSMemorialSerials",
                column: "Serial",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DSReceipts_ReceiptNumber",
                table: "DSReceipts",
